...
public class Parser {
    ...
    private void parseTerminal(String[] components, String line) throws UnrecognizedEntryException {
        ...
        } catch (CoreInvalidTerminalKeyException | CoreDuplicateTerminalException | CoreUnknownClientKeyException |
    ...
    private void parseFriends(String[] components, String line) throws UnrecognizedEntryException {
        ...
        } catch (CoreUnknownTerminalKeyException | CoreUnknownTerminalFriendKeyException e) {
